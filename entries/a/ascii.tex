...
\citeentry{win} -- but it did not provide for accented letters or any other
...
could be much worse. See \citeentry{EBCDIC} to understand how. A history of
...
\citeentry{bang}, \citeentry{excl}, \citeentry{open}, \citeentry{ques},
\citeentry{semi}, \citeentry{shriek}, \citeentry{splat}, \citeentry{twiddle},
and \citeentry{Yu-Shiang Whole Fish}.
...
particularly silly names introduced by \citeentry{INTERCAL}. The abbreviations
...
\citeentry{Commonwealth Hackish} has its own, rather more apposite use of
...
other, which has led to the \citeentry{ha ha only serious} suggestion that it
...
typeset material but the ASCII tilde serves for both (compare \citeentry{angle
brackets}).
...
280 machines). See also \citeentry{splat}.
...
serious \citeentry{misfeature} as the use of the international networks
continues to increase (see \citeentry{software rot}). Hardware and software
